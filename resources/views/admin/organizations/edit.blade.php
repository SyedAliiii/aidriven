            ...
            <div class="mt-4 flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex flex-wrap items-center gap-2">
                        <h1 class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-gray-100">Edit organization</h1>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update connection details for {{ $organization->name }}.</p>
                </div>
            </div>
                    ...
                    <div class="border-t border-gray-100 p-4 sm:p-6 dark:border-gray-800">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">Leave this blank to keep the existing password.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inline-flex rounded-lg border border-gray-200 bg-gray-50 p-1 dark:border-gray-700 dark:bg-gray-800/60">
                            <label class="cursor-pointer">
                                <input type="radio" name="status" value="active" class="peer sr-only"
                                    @checked(old('status', $organization->status) === 'active')>
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="status" value="inactive" class="peer sr-only"
                                    @checked(old('status', $organization->status) === 'inactive')>
