...
<div class="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100 tracking-tight">Users</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage accounts, organizations, and roles.</p>
        </div>
                            ...
                            <td class="px-5 py-3.5 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="inline-flex items-center gap-2">
                                        ...
                                        <button type="submit"
                                            class="h-8 px-3 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium transition">
                                            Save
                                        </button>
                                    </form>
